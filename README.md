...
Полноценный предпросмотр векторной графики при открытии XML файлов:

#### Основные возможности
- **Вкладка Preview** рядом с кодом для быстрого переключения
- **Zoom контролы** для изменения размера (64-1024 пикселей)
- **Информационная панель** с размерами и метаданными
