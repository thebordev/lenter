...
class CommentatorSettingsConfigurable : Configurable {
    ...
    private val panel: JPanel = FormBuilder.createFormBuilder()
        ...
        .addTooltip("ID проекта в Jira (числовое значение, например: 12500)")
        .addLabeledComponent("Project Key:", jiraProjectKeyField, 1, false)
        .addTooltip("Ключ проекта (например: SCC)")
        .addLabeledComponent("Issue Type ID:", jiraIssueTypeField, 1, false)
        .addTooltip("ID типа задачи (10101 = Bug, 10100 = Task)")
    ...
    override fun apply() {
        ...
        // Validate Jira settings (только если заполнены)
    ...
    override fun getDisplayName(): String = "Commentator"
}